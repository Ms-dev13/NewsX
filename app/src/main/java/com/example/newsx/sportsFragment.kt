...
class sportsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView.adapter = context?.let { NewsAdapter(it,emptyList()) }
        recyclerView.layoutManager = LinearLayoutManager(context)

        fetchSportsNewsData()
     }

    private fun fetchSportsNewsData() {
        ...
        api.getNews("us","sports","69de4efa7ada4f4da1bb5d4c42701c71")
                ...
                override fun onResponse(call: Call<NewsInfo>, response: Response<NewsInfo>) {
                    ...
                    if(response.isSuccessful){
                        response.body()?.let {
                            ...
                            recyclerView.adapter = context?.let { it1 -> NewsAdapter(it1,it.articles) }
                        }
                    }
